 ...
 */
function ButterflyCurve(origin, scale, loops, lambda) {
  let points = [];
  let stepSize = 0.025;
 ...
 * @param {number} loops  - number of loops to iterate
 */
function Hypocycloid(origin, scale, loops, r, R) {
  let points = [];
  let stepSize = 0.025;
  let upperLimit = loops * Math.PI;
 ...
 * @param {number} loops  - number of loops to iterate
 */
function Rose(origin, scale, loops, k) {
  let points = [];
  let stepSize = 0.025;
  let upperLimit = loops * Math.PI;
  for (let th = 0.0; th < upperLimit; th += stepSize) {
 ...
 */
function Rossler(origin, scale, loops, a, b, c, h) {
...
*/
function Lorentz(origin, scale, loops, x, y, z, a, b, c, h) {
 ...
 * @return a list of xy points
 */
function Attractor(origin, loops, entryString) {
...
/*a = -2.24, b = 0.43, c = -0.65, d = -2.43
  ...
  a = -2, b = -2, c = -1.2, d = 2
*/
function dejon(origin, a, b, c, d, scale = 100, loops = 10) {
  let points = []
  let xt = 1, yt = 1
  for (let i = 0; i < loops; i++) {
